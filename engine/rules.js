...
const redFlags = [
    ...
    {
      pattern: /bank account number|routing number|bvn|nin|social security|passport (copy|number)|driver'?s? license number/i,
      score: 46,
    ...
    {
      pattern: /invest(ment)?|capital|fund your account|bring (your own )?capital|personal investment/i,
      score: 44,
    ...
    {
      pattern: /task|mission|package|assignment|complete.*earn|daily (task|mission|assignment)/i,
      score: 28,
